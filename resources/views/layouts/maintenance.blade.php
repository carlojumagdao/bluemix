  ...
  <html lang="en">
    ...
    @yield('scripts')
      ...
      <script type="text/javascript" src="{!! URL::asset('../js/jquery.magnific-pop-up.js') !!}"></script>
      <script type="text/javascript" src="{!! URL::asset('../js/jquery.dataTables.js') !!}"></script>
      <script type="text/javascript" src="{!! URL::asset('../js/dataTables.material.min.js') !!}"></script>
    </body>
  </html>